...
public class JsDESUtil {
    ...
    private static final JsDESUtil instance = new JsDESUtil(); 
    private final String key1 = "m";
    private final String key2 = "s";
    private final String key3 = "o";

    // 静态方法返回该类的实例
    public static JsDESUtil getInstance() {  
        return instance;  
    }  
    ...
    public static void main(String[] args) {
        ...
        String key2 = "2";
        String key3 = "3";
        String data = "18217181759";
        String str = desObj.strEnc(data, key1, key2, key3);
        System.out.println(str);
        String dec = desObj.strDec("", key1, key2, key3);
     ...
     * @return
     */
    public String strDec_v1(String data){
    	return strDec(data,this.key1,this.key2,this.key3);
    }
