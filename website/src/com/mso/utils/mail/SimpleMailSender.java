...
public class SimpleMailSender extends BaseController {
	...
	public static void sendEmail(String SMTP, String PORT, String EMAIL,
		...
		mailInfo.setSubject(TITLE);
		StringBuffer email=new StringBuffer("<br/><p><B>此邮件由眸事网系统发出，系统不接收回信，请勿直接回复。</B></p><p>客户服务部&nbsp;<br/></p><p>");
		CONTENT = CONTENT +email.toString();
		mailInfo.setContent(CONTENT);
		// 这个类主要来发送邮件
		// 发送带签名的邮件
		// 账号
	...
	public static void main(String[] args) throws Exception {
		// 这个类主要是设置邮件
		MailSenderInfo mailInfo = new MailSenderInfo();
		mailInfo.setMailServerHost("mail.mso-china.com");
		mailInfo.setUserName("fh");
		mailInfo.setMailServerPort("25");
//		mailInfo.setValidate(true);
		mailInfo.setPassword("mission12345");// 您的邮箱密码
		mailInfo.setFromAddress("service@mso-china.com");
		mailInfo.setToAddress("essen.zhang@mso-china.com");
		mailInfo.setSubject("设置邮箱标题");
		mailInfo.setContent("设置邮箱内容");
		// 这个类主要来发送邮件
		
//		SimpleMailSender.sendEmail("mail.mso-china.com","fh","25","fh","essen.zhang@mso-china.com", "设置邮箱标题", "设置邮箱内容", "1");//调用发送邮件函数
		 SimpleMailSender sms = new SimpleMailSender();
