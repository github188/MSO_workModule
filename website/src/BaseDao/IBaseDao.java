...
public interface IBaseDao<T, ID extends Serializable> {
     ...
     */
    public abstract List<T> getListByHQL(String hqlString, ArrayList<Object> values);
//    public List<T> getListByHQL(String hqlString, ArrayList<Object> values)
     ...
     * @return 查询多个实体的List集合
     */
    public abstract List<T> getListBySQL(String sqlString,ArrayList<Object> values);
    
    /**
     * <根据SQL语句，得到对应的PageResults>
     * @param sqlString sQL语句
     * @param values 不定参数的Object数组
     * @param pageNo
     * @param pageSize
     * @return PageResults查询多个实体的List集合
     */
    public PageResults<T> findPageByFetchedSql(StringBuffer sql,
            int pageNo, int pageSize, ArrayList<Object> values) ;
    /**
     * <根据SQL语句，得到对应的list size>
     * @param sqlString HQL语句
     * @param values 不定参数的Object数组
     * @return 查询多个实体的List集合
     */
     ...
     * @param pageNo 下一页
     * @param pageSize 一页总条数
     * @param values 不定ArrayList<Object>数组参数
     * @return PageResults的封装类，里面包含了页码的信息以及查询的数据List集合
     */
    public PageResults<T> findPageByFetchedHql(String hql, String countHql,int pageNo, int pageSize, ArrayList<Object> values) ;
