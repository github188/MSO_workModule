		...
		return (<div className="cover1">
					<div className="cover-box">
						...
						<div className="context">
							...
							<a href="customer_new_demand.html">点此从新发布需求</a>
						</div>
				...
				{this.state.copyDemandHtml}
                 ...
                 <div className="context-explain package">
                     <div>
                        ...
                        {isNull(this.state.data.packageid)?<a href="javascript:;">
				                    <button type="button" id="copyDemand" className="submit">复制需求</button></a>:""}
       ...
       return (
         <div>
             ...
             <div className="right" style={{"margin-bottom":"20px","padding":"20px"}}>
               ...
               {isNull(this.state.data.packageid)?<button id="copyDemand" type="button" className="submit">复制需求</button>:""}
