          ...
          <div className="block-box">
            ...
            <div className="content-right">
                <ul>
                    <li>
                        <label>业务类型：</label>
                        <span className="types-of">数据加工</span><i><span className="help">?</span><span className="bubble">针对企业自有数据和需求，进行有效触达</span></i>
                    </li>
                    <li>
                        <label>清洗渠道：</label>
                        <span>电话</span>
                    ...
                    <li>
                        <label>数据条目：</label>
                        <input type="text" autoComplete="off" className="num" required onInput={this.handleInput.bind(this)} defaultValue="0" />
                    ...
                    <li>
                        <label>单价：</label>
                        <input type="text" autoComplete="off" className="money" required onInput={this.handleInput.bind(this)} defaultValue="1.5" />
          ...
          <div className="block-box">
            ...
            <div className="main">
                        <table>
                            <tr>
                                <td>需求名称：</td>
                                <td><input type="text" autoComplete="off" required className="demand-name" maxLength="12" /><span className="info">为您的需求命名，限制 12 个字</span>
                                    <p className="error">请填写需求名称</p>
                                </td>
                            </tr>
                            <tr>
                                <td style={{"verticalAlign": "top"}}>需求描述：</td>
                                <td><textarea maxLength="150" required className="descriptionDemand" onInput={this.handleInput.bind(this)}></textarea><p><span className="length">还可以输入 <span className="size2">150</span> 个字</span></p>
                                <p className="error">请填写需求描述</p></td>
                            </tr>

                            <tr>
                                <td><span>开始日期:</span></td>
                                <td className="date-p"><input type="text" autoComplete="off" className="form_date startDate" readonly onChange={this.handleInput.bind(this)} /><i className="date_icon"></i><span>结束日期:</span><input type="text" className="form_date endDate" readonly onChange={this.handleInput.bind(this)} /><i className="date_icon"></i>
                                <p className="error"></p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p className="radio_fz"><span>负责人姓名：</span><input type="text" autoComplete="off" style={{"width":"162px"}} className="pleader" /><span style={{"marginLeft":"84px"}}>负责人电话：</span><input autoComplete="off" type="text" className="pphone" style={{"width":"162px"}} /></p>
