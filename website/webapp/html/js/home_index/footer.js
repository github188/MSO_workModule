var Footer = React.createClass({
    ...
    render:function(){
        ...
        <div className="right" style={{"float":"none"}}><div><a className="footer-qq" href="//wpa.qq.com/msgrd?v=3&uin=2850840276&site=qq&menu=yes" target="_blank"></a><a><div><div><img src="/html/images/public/winxin_code.png" /><i></i></div></div></a></div><div><p>服务热线：</p><p>400-900-5288</p></div></div>
        </div>
        </div>
        </div>
        )
