                      ...
                      <div className="rowmain" style={{"padding":"40px"}}>
                          <table>
                              ...
                              <tr>
                                  ...
                                  <td  style={{"line-height":"14px"}}><span className="approveremark"></span></td>
                              </tr>
                          </table>
                      </div>
                  </div>
  ...
  if(JSON.parse(localStorage.getItem("data")).jfuid==localStorage.getItem("jfuid")){
	...
	$.ajax({
      ...
      success:function(data){
          if(data.code=="Y"){
			  console.log(data);
			  $("span.approveremark").text(data.approveremark);
			  $("input.compname").val(data.compname);
			  $("input.brandname").val(data.brandname);
			  $("input.compaddr").val(data.compaddr);
			  $("input.compwebsite").val(data.compaddr);
			  $("input.contacts").val(data.contacts);
			  $("input.contactsphone").val(data.contactsphone);
			  $("input.compemail").val(data.compemail);
			  $("input.qq").val(data.qq);
			  $("input.accountname").val(data.accountname);
			  $("input.bankaccount").val(data.bankaccount);
			  $("input.comaccount").val(data.comaccount);
