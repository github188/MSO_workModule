                       ...
                       <div>
                           ...
                           <div className="rowmain">
                               <table className="td-padding">
                                   <tr>
                                       <td width="110px" className="aRight"><span>公司全称：</span><span className="red">*&nbsp;</span></td>
                                       <td></td>
                                   </tr>
                                   <tr>
                                       <td className="aRight"><span>公司简称：</span><span style={{"visibility":"hidden"}}>*&nbsp;</span></td>
                                       <td></td>
                                   </tr>
                                   <tr>
                                       <td className="aRight"><span>公司地址：</span><span className="red">*&nbsp;</span></td>
                                       <td></td>
                                   </tr>
                                   <tr>
                                       <td className="aRight"><span>擅长行业：</span><span className="red">*&nbsp;</span></td>
                                       <td className="compind"></td>
                                   </tr>
                                   <tr>
                                       <td className="aRight"><span>擅长项目：</span><span className="red">*&nbsp;</span></td>
                                       <td className="scxm" width="704px"></td>
                                   </tr>
                                   <tr>
                                       <td className="aRight"><span>公司网址：</span><span style={{"visibility":"hidden"}}>*&nbsp;</span></td>
                                       <td></td>
                                   </tr>
                                   <tr>
                                       <td className="aRight"><span>公司规模：</span><span className="red">*&nbsp;</span></td>
                                       <td className="companysize"></td>
                                   </tr>
                                   <tr>
                                       <td className="aRight"><span>公司图片：</span><span style={{"visibility":"hidden"}}>*&nbsp;</span></td>
                                       <td></td>
                                   </tr>
                               </table>
                           </div>
          ...
          return(
                <div>
                    ...
                    <div className="rowmain">
                        <table className="td-padding">
                            <tr>
                                <td width="110px" className="aRight"><span>联系人：</span><span className="red">*&nbsp;</span></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td width="110px" className="aRight"><span>联系电话：</span><span className="red">*&nbsp;</span></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td width="110px" className="aRight"><span>电子邮箱：</span><span className="red">*&nbsp;</span></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td className="aRight"><span>QQ：</span><span style={{"visibility":"hidden"}}>*&nbsp;</span></td>
                                <td></td>
                            </tr>
                        </table>
                    </div>
              ...
              <div>
                      ...
                      <div className="rowmain" style={{"padding-right":"50px"}}>
                          <table className="td-padding">
                              ...
                              <tr>
                                  <td width="110px" className="aRight"><span>数据分布：</span><span className="red">*&nbsp;</span></td>
                                  <td></td>
                              </tr>
                          </table>
                      </div>
              ...
              return (
                    <div>
                          ...
                          <div className="rowmain">
                              <table className="td-padding">
                                  <tr>
                                      <td width="110px" className="aRight"><span>开户名称：</span><span className="red">*&nbsp;</span></td>
                                      <td width="704px"></td>
                                  </tr>
                                  <tr>
                                      <td width="110px" className="aRight"><span>开户行：</span><span className="red">*&nbsp;</span></td>
                                      <td></td>
                                  </tr>
                                  <tr>
                                      <td width="110px" className="aRight"><span>公司账号：</span><span className="red">*&nbsp;</span></td>
                                      <td></td>
                                  </tr>
                                  <tr>
                                      <td className="aRight"><span>开发票类型：</span><span className="red">*&nbsp;</span></td>
                                      <td></td>
                                  </tr>
                              </table>
                          </div>
    ...
    if(isNull(this.props.result)){
        return (
          <div>
                  ...
                  <div className="rowmain">
                      <table style={{"width":"100%"}} className="td-padding">
                          <tr>
                              <td width="33%"></td>
                              <td></td>
                              <td></td>
