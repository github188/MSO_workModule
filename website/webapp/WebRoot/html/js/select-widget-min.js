...
$.widget("ui.selectWidget", {
	...
	_selectFunctional: function() {
		...
		var e = this.element,
			...
			n = $("<div>").addClass("select-set").attr("id","select-set"),
		...
		t.append(i);
		e.after(t);
		e.css({"width":0,"position":"relative","left":0,"outline":"none","border":"0px","height":0,"display":"block"});
		i.hide();
		u.each(function(e, t) {
			s.append($("<li>").addClass("select-items").text($(t).text()).attr("title",$(t).text()))
		});
		f.click(function() {
