...
var DateFilter = React.createClass({
    ...
    handleInput: function () {
        var money=isNaN(Number($("input.num").val())) ? 0 : Number($("input.num").val());
        var  nums=isNaN($("input.money").val()) ? 0 : $("input.money").val();
        $("span.num").text(money+ "条");
        $("span.money").text("￥" + nums);
        $("span.total").text(parseInt(money * nums));
    },
    render: function () {
        return (
            <div className="block-box">
                ...
                <div className="content-right">
                    <ul>
                        <li>
                            <label>业务类型：</label>
                            <span className="types-of">数据加工</span><i><span className="help">?</span><span
                        ...
                        <li>
                            <label>数据条目：</label>
                            <input type="text" autoComplete="off" className="num" required
                                   onInput={this.handleInput.bind(this)} defaultValue="0"/>
                        ...
                        <li>
                            <label>单价：</label>
                            <input type="text" autoComplete="off" className="money" required
                                   onInput={this.handleInput.bind(this)} defaultValue="1.5"/>
                ...
                <div className="content-right">
                    <div className="main">
                        <table>
                            ...
                            <tr>
                                <td>需求名称：</td>
                                <td><input type="text" autoComplete="off" required className="demand-name"
                                           maxLength="12"/><span className="info">为您的需求命名，限制 12 个字</span>
                                    <p className="error">请填写需求名称</p>
                                </td>
                            </tr>
                            <tr>
                                <td style={{"verticalAlign": "top"}}>需求描述：</td>
                                <td><textarea maxLength="150" required className="descriptionDemand"
                            ...
                            <tr>
                                ...
                                <td className="date-p">
                                    <input type="text" autoComplete="off" className="form_date startDate" readOnly
                                           onChange={this.handleInput.bind(this)}/>
                                    <i className="date_icon">
                                    </i>
                                    <span>结束日期:</span><input type="text" className="form_date endDate" readOnly
                                                             onChange={this.handleInput.bind(this)}/>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p className="radio_fz"><span>负责人姓名：</span><input type="text" autoComplete="off"
                                                                                      style={{"width": "162px"}}
                                                                                      className="pleader"/><span
                                        style={{"marginLeft": "84px"}}>负责人电话：</span><input autoComplete="off"
                                                                                           type="text"
                                                                                           className="pphone"
                                                                                           style={{"width": "162px"}}/>
                                    </p>
    ...
    componentDidMount: function () {
        ...
        $(".btn_tj").click(function () {
            ...
            if ($("input").hasClass("error") || $("textarea").hasClass("error") || $("input.form_date").val() == "") {
                ...
                addDemand(1, file1, file2, file3, file4);
            }
        });
        $("button.btn_cg").click(function () {
            $(".loading_cover").show();
            sessionStorage.setItem("fdstate", 0);
            addDemand(0, file1, file2, file3, file4);
        });
    },
    render: function () {
        return (
            <div>
                <ul>
                    <li>
                        <label>业务类型：</label>
                        <span className="types-of">数据加工</span>
                    </li>
                    <li>
                        <label>清洗渠道：</label>
                ...
                <ul className="top">
                    ...
                    <li>
                        <label>需求单价：</label>
                        <span className="money">￥1.5</span>
                    </li>
                </ul>
                <p>总金额：</p>
                <h2><span className="total-d">￥</span><span className="total">0</span></h2>
                <div>
