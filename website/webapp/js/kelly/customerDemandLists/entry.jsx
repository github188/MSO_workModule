...
class Main extends React.Component {
    ...
    componentDidMount() {
        ...
        if (this.props.getCurrentSate) {
            ...
            this.props.getCurrentSate(function (data) {
                //console.log(data);
                this.getAllPageData({par: data});//TODO 根据传入的订单状态，获取数据
            }.bind(this));
        }
    ...
    render() {
        ...
        return (<div>
            <div style={{minHeight: 622}}>
                {this.state.AllMainHtml}
            </div>
            <div style={{textAlign: "right", padding: "30px 12px"}}>
                <Pagination style={{fontSize: "18px"}} showQuickJumper
        ...
        return (<div>
            ...
            <div className="cover1">
                <div className="cover-box">
                    ...
                    <div className="context" style={{"lineHeight": "200px"}}>已删除</div>
