...
module.exports = {
    entry: {
        newOrderList: "./src/components/newOrderList.jsx",
    ...
    module: {
        loaders: [
            ...
            // {
            //     loader:"style-loader!css-loader?modules&localIdentName=[path][name]---[local]---[hash:base64:5]",//css文件单独打包
            //     test: /\.css$/,
    ...
    plugins: [
        ...
        new openBrower({url: "http://localhost:3003/OrderList.html"}),
        new webpack.HotModuleReplacementPlugin(),//热加载模块，页面整体自动刷新
        new webpack.ProvidePlugin({$:"jquery",moment:"moment"}),// 全局挂载插件,等价于src引入
