...
export function addDemandSubmit() {
    ...
    var url = domain137 + `/quality/adddemand/${sessionStorage.getItem("jfuid")}/1?industryId=${$(".title_select").find("li.selected").find('a').attr("data-nfiid")}`;
    ...
    var data = {
        ...
        "industryId": $(".title_select").find("li.selected").find('a').attr("data-nfiid"),
