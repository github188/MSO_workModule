            ...
            return (
                <div style={{
                    "width": "auto"
                        ...
                        <div className="upload_submit" style={{
                    "width": "700px"
                }}>
        ...
        return (<table style={{
            ...
            {(Array.isArray(this.state.data) && this.state.data.length > 0) ? (this.state.data.map((v, k) => (
                ...
                style={{
                    "text-align": "left",
                    "padding": "20px 0px"
                }}>{this.state.type[v.type]}</td>
                    <td width="33.333%" style={{
                    "text-align": "center",
                    "padding": "20px 0px"
                }}>1 份</td>
                    <td width="33.333%" style={{
            ...
            if (fdstate == 2) {
                return (<div>
                    ...
                    <div className="right">
                        ...
                        "float": "left",
                        "margin-left": "20px"
                    }}>上传目标客户名单</span><a href="javascript:"className="upload_info_show" id="checkUp" style={{
                        "color": "#fff",
                        "font-size": "14px",
                        "float": "right",
                        "margin-right": "10px",
                        ...
                        "font-size": "14px"
                            ...
                            <div><div className="ossfile" style={{
                        "width": "180px"
                    }}></div><button type="button" className="btn" id="postfiles">开始上传</button></div>
...
$.ajax({
    ...
    success: function(result) {
        ...
        if (result.code == "0") {
            ...
            //各种参数详解  http://chaping.github.io/plupload/doc/
            var uploader = new plupload.Uploader({
                runtimes: 'html5,flash,silverlight,html4',  //用来指定上传方式
                browse_button: 'selectfiles',               //当点击该元素后便后弹出文件选择对话框。该值可以是DOM元素对象本身，也可以是该DOM元素的id
                //multi_selection: false,
                container: $('.container')[0],              //用来指定Plupload所创建的html结构的父容器，默认为前面指定的browse_button的父元素
                flash_swf_url: 'lib/plupload-2.1.2/js/Moxie.swf',       //swf文件，当需要使用swf方式进行上传时需要配置该参数
                silverlight_xap_url: 'lib/plupload-2.1.2/js/Moxie.xap', //silverlight文件，当需要使用silverlight方式进行上传时需要配置该参
                url: 'http://oss.aliyuncs.com',                         //服务器端上传的地址
                filters: {
