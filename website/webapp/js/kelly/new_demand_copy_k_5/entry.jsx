...
class Yewu extends React.Component {
    ...
    init() {
        ...
        if (this.props.industry) {
            ...
            var twolevindustry = industry.indusryProperties; //1线上、0线下
    ...
    updataStructrue(id) {
        ...
        this.getIndustryData(function(onlineAndOffline) {
            ...
            /*线下*/
            this.setState({
                onlineAndOffline: onlineAndOffline[0].list
            });

            this.setState({
                onlineAndOfflineHtml: this.createIndustry(dataId)
            });
    ...
    selectIndustry() {
        ...
        this.rootEl.on('click', '.leavalFirst li', function(ev) {
            ...
            this.setState({
                leavalLastdata: dataList
            });
            this.setState({
                leavalLastHtml: this.createleavalLastHtml()
            });
    ...
    render() {
        return (
            ...
            style={{
                width: '370px'
            }} className="industry select area js_area" data-txt={" "}
...
class Mbkh extends React.Component {
    ...
    controlCrowd() {
        ...
        this.rootEl.on('input', '.people-yang input.first', function(ev) {
            ...
            this.setState({
                range: [firstValue * 1, $('.people-yang input.last').val() * 1]
            });
        }.bind(this));
        ...
        this.rootEl.on('input', '.people-yang input.last', function(ev) {
            ...
            this.setState({
                range: [$('.people-yang input.first').val() * 1, lastValue * 1]
            });
        }.bind(this));
...
class AreaAndRequirement extends React.Component {
    ...
    componentDidMount() {
        this.setState({
            hotCityHtml: this.createHotCity()
        });
        /*abc def top*/
        this.setState({
            cityTopHtml: this.createCityTop()
        });
        /*获取选择城市数据*/
        this.getChooseCityData(function(data) {
            ...
            /*第一次默认abc*/
            this.setState({
                chooseCityHtml: this.createChooseCity(['A', 'B', 'C'])
            });
        ...
        this.chooseTypeCityEvent(function(data) {
            this.setState({
                chooseCityHtml: this.createChooseCity(data)
            });
        }.bind(this));
        ...
        this.setState({
            arealistHtml: this.createAreaHtml()
        });
    ...
    delMutilCityEvent() {
        this.rootEl.on('click', 'i.close', function(ev) {
            ...
            this.setState({
                areaLength: this.rootEl.find(".areaList").length
            });
            ReactDOM.render(<Preview name='1' data={areaList()}/>, $(".demend_right .right")[0]);
        }.bind(this));
    }
    ...
    getAreaData(callBack) {
        ...
        }.bind(this)).done(function() {}).fail(function(data) {
            /*假数据*/
        });
    }
    ...
    getProvinceData(callBack) {
        ...
        $.when($.ajax({
            ...
            if (!data.basreglist[0]) return;
            callBack(data.basreglist);
        }.bind(this)).done(function() {}).fail(function() {});
    }
    ...
    selectArea() {
        ...
        if (this.state.controlVar == 'city') {
            ...
            console.log('this.state.provinceHtml');
            return this.state.provinceHtml;
        } else if (this.state.controlVar == 'area') {
            console.log('this.state.areaTtml');
...
class SaleTemplate extends React.Component {
    ...
    init() {
        ...
        this.getfreelabelData(function(data) {
            ...
            this.setState({
                freelabelHtml: this.createfreelabel()
            });
        }.bind(this));
        this.getchargelabelData(function(data) {
            ...
            this.setState({
                chargelabelHtml: this.createchargelabel()
            });
        }.bind(this));
    }
    ...
    addlabel() {
        ...
        this.rootEl.on("click", ".label_add button", function() {
            ...
            if (length < 20) {
                ...
                this.setState({
                    diylabellength: this.rootEl.find(".diylabel").length
                });
            } else {
    ...
    render() {
        return (
            ...
            className="activelength">{this.state.activelength}</span>  个</span><span>单价： 
...
class EssentialInformation extends React.Component {
    ...
    inputsize() {
        this.rootEl.find(".descriptionDemand").on("input", function(ev) {
            this.setState({
                descriptionDemandLength: $(ev.currentTarget).val().length
            });
        }.bind(this));
            ...
            type="radio" name="isFZ" defaultChecked required/>否</label></p>
                ...
                "width": "162px"
                                ...
                                <div>
                                    ...
                                    <input autoComplete="off" type="text" style={{
                "width": "162px"
            }}
            className="pphone"/>
...
class Preview extends React.Component {
    ...
    save() {
        this.rootEl.find("button.btn_tj2").click(function() {
            ...
            var cgid;
            choose ? cgid = location.hash.slice(5) : cgid = location.hash.slice(1);
            var data = {
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.msg == "success") {
                        ...
                        sessionStorage.setItem("cgid", cgid);
