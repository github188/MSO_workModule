    ...
    */
    changeDemandReport(id) {
        this.queryDemandReport(id, function(result) {
            ...
            var releasenumSum = (result.data.unfinishNum || 0) * 1 + (result.data.finishNum || 0) * 1 > 0 ? (result.data.unfinishNum || 0) * 1 + (result.data.finishNum || 0) * 1 : 1;
            this.setState({
                releasenum: arr,
                censusday: dayArr,
                checkReleasenum: result.data.qualityNum || 0,
                paymentmoneySum: addMark(result.data.settlementTotalPrice || 0),
                noFinishSum: result.data.unfinishNum || 0, //未完成量
                paymentnumSum: result.data.finishNum || 0,
                nofinishScale: (result.data.unfinishNum || 0) / releasenumSum,
                finishScale: (result.data.finishNum || 0) / releasenumSum
