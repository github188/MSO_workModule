...
class LoginBox extends React.Component{
	constructor(props) {
		...
		this.state = {
            ...
            headurls:"/images/demand/icon-user.png",
            showName:"helloWorld",
    ...
    componentWillMount(){
	  var showName = "";
	  var invitationcode = "";
	 // var headurls = "/images/demand/icon-user.png";
      this.setState({
            showName: showName,
	...
	<p>用户名：{sessionStorage.getItem("showName")}</p>
                                    <p>邀请码：{sessionStorage.getItem("invitationcode")}</p>
                                </div>
                            </div>
                ...
                <div className="cover">
                	<div className="cover-box">
                		...
                		<div className="context" style={{"lineHeight":"200px"}}>您还未完善信息，无法发布需求！<a href="customerMyInfo.html">点此完善信息>></a></div>
...
class Topnav extends React.Component{
	constructor(props) {
		...
		this.state = {  
			menus:[
				{name:'首页',link:'/html/supplier_index.html'},
				{name:'需求大厅',link:'/html/supplierDemandHall.html'},
				{name:'我的订单',link:'/html/supplierDemandList.html'},
				{name:'成单报表',link:'/html/supplier_reports_1.html'},
				{name:'服务平台',link:'javascript:;'},
			],
			MenuHeadHtml:''
		}
		this.init();
	...
	updataHeadHtml(){
		this.setState({
			MenuHeadHtml:this.createMenuHead()
		})
	}
	createMenuHead(){
		return this.state.menus.map((name,index)=>{
			return(<li key={index}><a href={name.link}>{name.name}</a></li>);
		});
	}
	render(){
		//href="../index.html"
		return (
			<div className="top">
				<div className="logo">
					<a href="//vendor.mshuoke.com" >
						<img src="/images/public/logo-white.png" />
					</a>
					<span className="logo-info">&nbsp;|&nbsp;服务商平台</span>
	            </div>
				<div className="menu">
					<ul>
					{this.state.MenuHeadHtml}
					</ul>
				</div>
				<LoginBox />
			</div>
