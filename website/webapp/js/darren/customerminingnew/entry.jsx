      ...
      return(
            <table>
                ...
                <tr>
                    ...
                    {isNull(this.state.data.productaccessories)?"":<p>产品介绍附件:<a href={isNull(this.state.data.productaccessories)?"javascript:":domainDownShort+this.state.data.productaccessories} style={{"color":"#1aa0ff"}}>下载>></a></p>}
                    </td>
                </tr>
                <tr>
                    <td>开始日期:</td>
                ...
                <tr>
                    <td>负责人电话:</td>
                    <td><span>{isNull(this.state.data.pphone)?"暂无":this.state.data.pphone}</span></td>
                </tr>
            </table>
      )
    }
...
// <td>发布数量:</td>
// <td>{result.releasenum}&emsp;条</td>
// <td>单价:</td>
// <td>{result.orderprice}&emsp;元</td>
// <td>总价:</td>
// <td>{result.orderpricetol}&emsp;元</td>
// </tr>
// <tr>
// <td>单价说明:</td>
// <td colSpan="4">{isNull(result.subdescription)?"暂无":result.subdescription}</td>
// </tr>
// </tbody>
    ...
    return(
          ...
          return (
              <div className="areaList">
                  ...
                  <br/>
                  <div className="input"><label>单价说明:</label><span>{isNull(result.subdescription)?"暂无":result.subdescription}</span></div>
              </div>
              )
          })
          }
				...
				return(<div>
							<div className="right" style={{"margin-bottom":"20px"}}>
							 ...
							 <div className="right" style={{"margin-bottom":"20px","padding":"20px"}}>
							   ...
							   {isNull(packageid)?<a href={"new_demand_copy_2.html#"+demandid}><button id="copyDemand" type="button" className="submit hide">复制需求</button></a>:""}
				 ...
				 <div className="right">
				   ...
				   <div className="context-explain package">
					   <div>
						  ...
						  {isNull(this.props.data.packageid)?<a href={"new_demand_copy_2.html#"+demandid}><button id="copyDemand" type="button" className="submit hide">复制需求</button></a>:""}
  ...
  copyDemandEvent(){
	...
	checkIndustry(data){
		switch(data.industry){
			case ("汽车行业"):
			return (<a href={"new_demand_copy_2.html#"+demandid}><button id="copyDemand_1" type="button" className="submit hide">复制需求</button></a>);
			case ("医美行业"):
			return (<a href={"new_demand_copy_2.html#"+demandid}><button id="copyDemand_1" type="button" className="submit hide">复制需求</button></a>);
			case ("房地产"):
			return (<a href={"new_demand_copy_2.html#"+demandid}><button id="copyDemand_1" type="button" className="submit hide">复制需求</button></a>);
			...
			return (<a href={"new_demand_copy_2.html#"+demandid}><button id="copyDemand_1" type="button" className="submit hide">复制需求</button></a>);
			case ("教育培训"):
			return (<a href="javascript:;"><button id="copyDemand" type="button" className="submit">复制需求</button></a>);
		}
