		...
		return (
		    <table>
                ...
                <tr>
                    ...
                    <td className="zdy"><input autoComplete="off" type="text" placeholder="请输入自定义人群（12个字以内）" className="mbrq" style={{"width":"234px"}} /></td>
                </tr>
                <tr className="task-age-box">
                    ...
                    <td className="age">
					<input autoComplete="off" type="number" className="startAge ageCalculation"  defaultValue="8" min="0"  /> - <input autoComplete="off" type="number" className="endAge ageCalculation"  defaultValue="38" max="120" />
			...
			<table>
			 <tbody>
				...
				<tr>
					...
					<td><textarea maxLength="150" className="descriptionDemand" ></textarea><p><span className="length">还可以输入 <span className="size2">150</span> 个字</span></p>
					<p className="error">请填写需求描述</p></td>
				</tr>
				<tr>
					<td>产品名称：</td>
					<td>
						<input  type="text" maxLength="12" className="pro-name" name="proname" autoComplete="on" /><span className="info">您的产品或服务名，限制 12 个字</span>
				...
				<tr>
					...
					<td>
						<textarea maxLength="150" className="introductionPro"  placeholder="产品或服务介绍，可上传附件，可填入网站链接" ></textarea>
		...
		return this.state.countNumber.map(function (name,index){
			return (
					...
					<div className="input js_input">
						<label>目标区域:</label>
						<input type="text"  data-index={"index" +index} className={"select area js_area"} placeholder="请选择区域" title="" />
