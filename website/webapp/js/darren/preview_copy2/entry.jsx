		...
		return(
          <table>
              ...
              <tr>
                  ...
                  <td className="zdy"><input type="text" placeholder="请输入自定义人群（12个字以内）"  defaultValue={data.targethumen} style={{"width":"234px"}} /></td>
              </tr>
              <tr>
                  <td>对象年龄：</td>
				  <td><Demo change={this.change} rangeArr = { this.state.range } /></td>
                  <td className="age">
				  <input type="number" required defaultValue={data.beginage} min="0" max="120" className="startAge"/> - <input type="number" required  min="0" max="120" defaultValue={data.endage} className="endAge"/><span style={{"marginLeft":"12px","color":"#999"}}>周岁</span>
  ...
  componentDidMount:function(){
      ...
      $(".main div[class^=areaList]:not(.areaList_add) .isNote input[name^=note]").live("change",function(){
       ...
       $("input.area").on("click",function(){
              ...
              ReactDOM.render(<Area area={area} province={province} hotCity={hotCity} index={index}/>,$("#new_demand div.demend_left div.area")[0]);
...
function getUrlGetDetailHfp(getDetailHfp){
  setTimeout(function(){
    ReactDOM.render(<Yewu data={getDetailHfp}/>,$("#new_demand div.demend_left .form_col1>.main")[0]);
    ReactDOM.render(<Mbkh data={getDetailHfp}/>,$("#new_demand div.demend_left .form_col2>.main")[0]);
    ReactDOM.render(<Jbxx data={getDetailHfp}/>,$("#new_demand div.demend_left .form_col3>.main")[0]);
    ReactDOM.render(<Fbfb data={getDetailHfp}/>,$("#new_demand div.demend_left .form_col4>.main")[0]);
    ReactDOM.render(<Fj data={getDetailHfp}/>,$("#new_demand div.demend_left .form_col5>.main")[0]);
    ReactDOM.render(<Preview data={getDetailHfp}/>,$("#new_demand div.demend_right .right").eq(0)[0]);
    ReactDOM.render(<Progress_speed data={getDetailHfp}/>,$(".progress_speed")[0]);
    ReactDOM.render(<JinE data={areaList()}/>,$("#new_demand div.demend_right .right").eq(1)[0]);
