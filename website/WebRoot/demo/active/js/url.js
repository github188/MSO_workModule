...
//1.1 有的时候-直接显示
//1.2 没有的时候再取值并存
//sessionStorage.removeItem("jfuid");
//sessionStorage.setItem("jfuid", "20160822051038920");
//sessionStorage.setItem("demandid", "20160721105121937");


//alert(sessionStorage.getItem("invitationcode"));


//localStorage.setItem("jfuid", "140");
//localStorage.setItem("jfustate", "3");
// var jfuid = sessionStorage.getItem("jfuid");
// sessionStorage.setItem("demandid", "20160721105121937");//20160822053617565
// sessionStorage.setItem("showName","helloWorld");
// sessionStorage.setItem("invitationcode","52A413");
...
//	oJfuid = sessionStorage.getItem("jfuid");
//	oDemandid = sessionStorage.getItem("demandid");
//}else{
//		//alert("请先登录");
...
//var domain = "http://www.mshuoke.com";
var domainDown = "//res.mshuoke.com";//下载前缀
var domainDownShort = "//res.mshuoke.com/";//下载前缀
var serverUrl="";
...
//需求列表
var demandList = "/getHfps";

//注册接口
var toRegoster="/user_toRegoster";
//手机号验证码
var telCode="/user/telCode";
//邮箱验证
...
//接包方每日报表
var reportj="/report/j";
//发包方每日报表
var reportf="/report/f";
...
//
var urlJfuinvitationcode = domain + jfuinvitationcode.format({jfuinvitationcode:sessionStorage.getItem("invitationcode")});
