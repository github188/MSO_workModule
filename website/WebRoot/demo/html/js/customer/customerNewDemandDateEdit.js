            ...
            <div className="main">
                        <table>
                            ...
                            <tr>
                                ...
                                <td><input autoComplete="off" type="text" defaultValue={data.begintime} className="form_date startDate" readonly onChange={this.handleInput.bind(this)} /><i className="date_icon"></i><span>结束日期:</span><input type="text" defaultValue={data.endtime} className="form_date endDate" readonly onChange={this.handleInput.bind(this)} /><i className="date_icon"></i></td>
                            </tr>
                            <tr>
