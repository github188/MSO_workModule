    ...
    i(u, [], function () {
        ...
        function o() {
            ...
            function o(e) {
                ...
                return !n || !l.length || -1 !== t.inArray(n, l)
            }
            ...
            t.extend(this, {
                init: function (n) {
                    var r = this, s;
                    d = n, l = e(d.accept), s = d.container, i.addEvent(s, "dragover", function (e) {
                        e.preventDefault(), e.stopPropagation(), e.dataTransfer.dropEffect = "copy"
                    }, r.uid), i.addEvent(s, "drop", function (e) {
                        if (e.preventDefault(), e.stopPropagation(), c = [], e.dataTransfer.items && e.dataTransfer.items[0].webkitGetAsEntry) {
                            var n = [];
                    ...
                    i.removeAllEvents(d && n.get(d.container), this.uid), c = l = d = null
                }
            })
        }
...
;(function (e, t, n) {
    ...
    var r = e.setTimeout, i = {}, o = {
        ...
        formatSize: function (e) {
            ...
            return e > r ? parseInt(t(e / r, 1)) + "" + o.translate("tb") : e > (r /= 1024) ? parseInt(t(e / r, 1)) + "" + o.translate("gb") : e > (r /= 1024) ? parseInt(t(e / r, 1)) + "" + o.translate("mb") : e > 1024 ? parseInt(Math.round(e / 1024)) + "" + o.translate("kb") : parseInt(e) + "" + o.translate("b")
        },
