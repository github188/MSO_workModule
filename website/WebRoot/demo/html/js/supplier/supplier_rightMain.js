...
var Sjkxx=React.createClass({
  render:function(){
      ...
      //                         <td width="110px"><span className="red">*&nbsp;</span><span>自有数据库：</span></td>
      //                         <td width="706px">
      //                             <label><input type="radio" defaultChecked={this.props.data.hasdb==0?true:false} name="zysjk"/><span>无</span></label>
      //                             <label><input type="radio" defaultChecked={this.props.data.hasdb==1?true:false} name="zysjk"/><span>有</span></label>
      //                         </td>
      //                     </tr>
      //                     <tr id="zysjk" style={{"display":this.props.data.hasdb==1?"table-row":"none"}}>
      //                         <td rowSpan="3" width="110px"><span className="red">*&nbsp;</span><span>数据分布：</span></td>
      //                         <td>
      //                             <label><input type="radio" defaultChecked={this.props.data.datacity=="全国"?true:false} name="sjfb"/><span>全国</span></label>
      //                             <label><input type="radio" defaultChecked={this.props.data.datacity!="全国"?true:false} name="sjfb"/><span>自定义城市</span></label>
      //                         </td>
      //                     </tr>
      //                     <tr id="zdycs" style={{"display":this.props.data.hasdb==1&&this.props.data.datacity!="全国"?"table-row":"none"}}>
      //                         <td style={{"line-height":"26px"}}><span>已选择:</span><div><div className="activeCity"><ul></ul><button type="button" className="btn add_city area">选择城市</button></div></div></td>
      //                     </tr>
      //                     <tr  style={{"display":this.props.data.hasdb==1?"table-row":"none"}}>
      //                         <td><p className="error-info">请选择至少一个城市作为数据分布城市</p></td>
      //                     </tr>
      //                 </table>
      //             </div>
