      ...
      return(
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" className="form_date startDate" required  autoComplete="off" onChange={this.handleInput.bind(this)}/><i className="date_icon"></i><span>结束日期:</span><input type="text" className="form_date endDate" autoComplete="off" required onChange={this.handleInput.bind(this)}  /><i className="date_icon"></i>
    ...
    if(isNull(this.props.data)){
         ...
         return (
             <div>
                 ...
                 <i className="close"></i>
                 <div className="input isNote"><label>是否备注:</label><label><input type="radio" name={"note"+this.props.length} defaultChecked={!isNull(this.props.data.subdescription)} /><span>是</span></label><label><input type="radio" name={"note"+this.props.length} defaultChecked={isNull(this.props.data.subdescription)} /><span>否</span></label></div>
 ...
 $.ajax({
     ...
     success:function(result){
         ...
         if(result.code=="Y"){
         	...
         	console.log(result.detail.industry);
