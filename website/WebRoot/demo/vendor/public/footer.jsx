			...
			<div>
				<div className="nav_bottom">
					<div>
						...
						<div className="right" style={{"float":"none"}}><div><a href="//wpa.qq.com/msgrd?v=3&uin=2850840269&site=qq&menu=yes"></a><a><div><div><img src="../../../images/winxin_code.png" /><i></i></div></div></a></div><div><p>服务热线：</p><p>400-900-5288</p></div></div>
					</div>
				</div>
			</div>
		)
