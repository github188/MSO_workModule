...
function topStick(){
	$(window).scroll(function(){
	  if($(window).scrollTop()>=260){
		$(".demend_right .right").css({"position":"fixed","top":"60px"});
		if($(".demend_right .right").offset().top+$(".demend_right .right").height()>=$(".demend_left").offset().top+$(".demend_left").height()-20){
		  $(".demend_right .right").css({"position":"absolute","top":$(".demend_left").height()-$(".demend_right .right").height()+238});
		}else{
		  $(".demend_right .right").css({"position":"fixed","top":"60px"});
		}
	  }else{
