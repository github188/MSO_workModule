    		...
    		<div class="mid_box">
	    		...
	    		<div class="content_mid">
	    			<div class="main_overview">
	    				<div class="title">待上架需求</div>
	    				<%@ include file="../searchForm.jsp"%>
	    			</div>
	    			<div class="tab_overview" style="min-height:560px;">
					    <div class="tab_menu book_style">
					        <ul>
								<c:if test="${zt=='dsjdemand'}">
						    		<li id="demandli1" class="selected" onclick="demanList('dsjdemand')">全部</li>
						    	</c:if>
						    	<c:if test="${zt!='dsjdemand'}">
						    		<li id="demandli1" onclick="demanList('dsjdemand')">全部</li>
						    	</c:if>
				
								<c:if test="${zt=='cgxdemand'}">
						    		<li id="demandli2" class="selected" onclick="demanList('cgxdemand')">草稿箱</li>
						    	</c:if>
						    	<c:if test="${zt!='cgxdemand'}">
						    		<li id="demandli2" onclick="demanList('cgxdemand')">草稿箱</li>
						    	</c:if>
						    	
						    	<c:if test="${zt=='shzdemand'}">
						    		<li id="demandli3" class="selected"  onclick="demanList('shzdemand')">审核中</li>
						    	</c:if>
						    	<c:if test="${zt!='shzdemand'}">
						    		<li id="demandli3" onclick="demanList('shzdemand')">审核中</li>
						    	</c:if>
