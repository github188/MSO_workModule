...
module.exports = {
    ...
    output: {
        ...
        path: "../node_test/public",//指定输出文件路径，通常设置为__dirname + ‘/build’,
        filename: "js/[name].js"
    },
    module: {
        loaders: [
    ...
    plugins: [
        ...
        new ExtractTextPlugin("css/[name].css"/*,{ allChunks: true}*//*多个文件合成一个文件*/),//分离css，设置文件名
        ...
        new webpack.optimize.CommonsChunkPlugin({name: "vendors", filename: "js/vendors.js", minChunks: Infinity})]//将依赖分离打包
}
//安装依赖
