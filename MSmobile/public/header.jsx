			...
			$.ajax({
				...
				success: function (data) {
					if (data.code == "Y") {
						...
						window.location.href = "https://vendor.mshuoke.com/";
					} else {
						return false;
					}
				},
			...
			return (
					<div>
						<div className="nav_top">
							<div>
								<div className="c_home_logo"><a href="//vendor.mshuoke.com"><img
									src="/images/c_index_logo.png" title="MSO-眸事网，国内专业营销服务外包平台"
									alt="logo"/>&nbsp;|&nbsp;服务商平台</a></div>
								<ul>
									<a href="/index.html"><li>首页<i></i></li></a>丨
									<a href="/joined-policy.html"><li>加盟政策<i></i></li></a>丨
									<a href="/platform_support.html"><li>平台支持<i></i></li></a>丨
								<a href="/help.html"><li>帮助中心<i></i></li></a>
								</ul>
								<div className="login_right">
									<a href="https://www.mshuoke.com/html/PerfectData.html" className="MyInfo">{username}</a>
						...
						<div className="nav_top">
							<div>
								...
								<div className="c_right">
									...
									<a href="//www.mshuoke.com/register.html?jfutype=2">注册</a>
								</div>
